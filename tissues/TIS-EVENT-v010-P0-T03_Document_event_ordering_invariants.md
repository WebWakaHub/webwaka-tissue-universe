# [TIS-EVENT-v0.1.0-P0-T03] Document event ordering invariants

**Structure:** `[TIS-EVENT-v0.1.0-P0-T03] Document event`
**Layer:** Tissue
**Issue:** #552
...
The implementation of this issue satisfies all constitutional requirements for the `[TIS-EVENT-v0.1.0-P0-T03] Document event` structure at the Tissue layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
