# [TIS-EVENT-v0.1.0-P0-T02] Specify event routing protocol

**Structure:** `[TIS-EVENT-v0.1.0-P0-T02] Specify event `
**Layer:** Tissue
**Issue:** #551
...
The implementation of this issue satisfies all constitutional requirements for the `[TIS-EVENT-v0.1.0-P0-T02] Specify event ` structure at the Tissue layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
