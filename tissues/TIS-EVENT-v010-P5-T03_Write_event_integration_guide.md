# [TIS-EVENT-v0.1.0-P5-T03] Write event integration guide

**Structure:** `[TIS-EVENT-v0.1.0-P5-T03] Write event in`
**Layer:** Tissue
**Issue:** #572
...
The implementation of this issue satisfies all constitutional requirements for the `[TIS-EVENT-v0.1.0-P5-T03] Write event in` structure at the Tissue layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
