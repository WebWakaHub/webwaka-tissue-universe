# [TIS-VALIDATE-v0.1.0-P0-T02] Specify validation protocol

**Structure:** `[TIS-VALIDATE-v0.1.0-P0-T02] Specify val`
**Layer:** Tissue
**Issue:** #580
...
The implementation of this issue satisfies all constitutional requirements for the `[TIS-VALIDATE-v0.1.0-P0-T02] Specify val` structure at the Tissue layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
