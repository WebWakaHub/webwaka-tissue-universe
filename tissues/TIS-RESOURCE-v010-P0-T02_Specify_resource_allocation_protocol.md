# [TIS-RESOURCE-v0.1.0-P0-T02] Specify resource allocation protocol

**Structure:** `[TIS-RESOURCE-v0.1.0-P0-T02] Specify res`
**Layer:** Tissue
**Issue:** #609
...
The implementation of this issue satisfies all constitutional requirements for the `[TIS-RESOURCE-v0.1.0-P0-T02] Specify res` structure at the Tissue layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
